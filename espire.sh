...
sudo pacman --needed -S vulkan-intel zathura-pdf-poppler i3-gaps ttf-roboto-mono ttf-fira-code ttf-nerd-fonts-symbols-2048-em ttf-sazanami ttf-liberation \
...
paru -S  cli-visualizer zaread nsxiv brillo python-pywalfox proton-ge-custom \
