...
ROOT_SIZE=20G      # Applies to either root partition or root logical volume
#SWAP_SIZE=4G        
SWAP_SIZE="$(free | awk '/^Mem/ {mem=$2/1000000; print int(2.2*mem)}')G"
...
base_system=( base base-devel linux linux-headers dkms linux-firmware neovim sudo bash-completion )
